...
exports.default = {
  guard(m) {
    return !m.recordMissingReady && m.private.client && m.private.client.isConnected && m.specifyStateAt === m.stateAt;
  },
  execute(m) {
    const now = new Date();
    ...
    return Object.keys(m.sources).filter(sourceKey => {
      ...
      return threshold && source.recordAckAt && now - source.recordAckAt > threshold * 1000;
    });
  },
  assign(m, res) {
