...
module.exports = {
  guard(m) {
    return !m.recordMissingReady && m.private.ldmpClient && m.private.ldmpClient.isConnected && m.ldmpSpecifyTs === m.versionTs;
  },
  ...
  execute(m) {
    ...
    return Object.keys(m.sources).filter(sourceKey => {
      ...
      return threshold && source.ackTs && now - source.ackTs > threshold * 1000;
    });
  },
